...
class Preload extends Phaser.Scene{
    ...
    preload() {
        ...
        //load btn_level1
        this.load.image("btn_level1","assets/Botoes/btn_level1.png");
        //load btn_level2
        this.load.image("btn_level2","assets/Botoes/btn_level2.png");
        //load btn_level3
        this.load.image("btn_level3","assets/Botoes/btn_level3.png");
        //load btn_level4
        this.load.image("btn_level4","assets/Botoes/btn_level4.png");
        ...
        //musica level2
        this.load.audio("level2_music","assets/Music/level2_music.mp3");
        //musica level3
        this.load.audio("level3_music","assets/Music/level3_music.mp3");
        //musica level4
        this.load.audio("level4_music","assets/Music/level4_music.mp3");
        //musica level5
        this.load.audio("level5_music","assets/Music/level5_music.mp3");
        //musica shoot
        this.load.audio("shoot_music","assets/Music/shoot_music.mp3");
        //musica laser
        this.load.audio("laser_music","assets/Music/laser_music.mp3");
        //musica player hurt
